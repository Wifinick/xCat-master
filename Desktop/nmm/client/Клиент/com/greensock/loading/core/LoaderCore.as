	...
	public class LoaderCore extends EventDispatcher {
		...
		public function LoaderCore(vars:Object=null) {
			...
			if (_globalRootLoader == null) {
				...
				_isLocal = Boolean(Capabilities.playerType == "Desktop" || (new LocalConnection( ).domain == "playxcat.ru")); //alt method (Capabilities.playerType != "ActiveX" && Capabilities.playerType != "PlugIn") doesn't work when testing locally in an html wrapper
			}
